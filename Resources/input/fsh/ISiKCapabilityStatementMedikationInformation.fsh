...
* rest
  ...
  * resource[0]
    ...
    * supportedProfile = "https://gematik.de/fhir/isik/v3/Medikation/StructureDefinition/ISiKMedikationsInformation"
    * interaction[0]
      * extension
        * url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
        * valueCode = #SHALL
  ...
  * resource[+]
    * extension
      ...
      * valueCode = #SHALL
    * type = #List
    * supportedProfile = "https://gematik.de/fhir/isik/v3/Medikation/StructureDefinition/ISiKMedikationsListe"
    * interaction[0]
      * extension
        * url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
        * valueCode = #SHALL
  ...
  * resource[+]
    * extension
      ...
      * valueCode = #SHALL
    * type = #Medication
    * supportedProfile = "https://gematik.de/fhir/isik/v3/Medikation/StructureDefinition/ISiKMedikament"
    * interaction[0]
      * extension
        * url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
        * valueCode = #SHALL
