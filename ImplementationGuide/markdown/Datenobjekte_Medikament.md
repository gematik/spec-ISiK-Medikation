...
@```
from StructureDefinition where url = 'https://gematik.de/fhir/isik/v2/Medikation/StructureDefinition/ISiKMedikament' select Name: name, Canonical: url
```

{{tree:https://gematik.de/fhir/isik/v2/Medikation/StructureDefinition/ISiKMedikament, hybrid}}
...
where url in ('https://gematik.de/fhir/isik/v2/Medikation/StructureDefinition/ISiKMedikament')
...
1. Der Suchparameter "code" MUSS unterstützt werden:
    ...
    ```Medication?http://fhir.de/CodeSystem/bfarm/atc|V03AB23```
