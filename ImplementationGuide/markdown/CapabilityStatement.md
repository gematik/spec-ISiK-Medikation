...
Die für dieses Modul bestätigungsrelevanten Teile des [Moduls "Basis"](https://simplifier.net/guide/isik-basis-v3?version=current) sind in den CapabilityStatements ebenfalls enthalten.
