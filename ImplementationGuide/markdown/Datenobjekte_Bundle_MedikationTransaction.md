...
Hinweis: Die Regeln aus dem Modul [ISiK Basis Stufe 3](https://simplifier.net/guide/isik-basis-v3?version=current) für die Verarbeitung Document-Bundles, treffen hier nicht zu, da es sich um den Bundle-Typ Transaction handelt.
